...
class StyleImageSelector extends React.Component {
        ...
        render() {
                ...
                return ( <
                        ...
                        style = {
                            { marginBottom: '.1rem', display: 'inline-block', verticalAlign: 'middle' }
                        } >
                        <
                        Typography style = {
                        ...
                        <
                        Slider className = { classes.formControl }
                        ...
                        color = "secondary" > Style Image < /InputLabel> <
                        Select labelId = "content-label"
                        id = "content-select"
                        value = { this.state.image }
                        onClick = { this.handleMenu }
                        color = "secondary"
                        label = "Style Image" > {
                            this.state.menulist.map(option => ( < MenuItem key = { option.value }
